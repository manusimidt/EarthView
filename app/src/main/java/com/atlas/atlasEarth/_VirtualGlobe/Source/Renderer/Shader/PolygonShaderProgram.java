...
public class PolygonShaderProgram extends ShaderProgramGL3x{
    private int location_projectionMatrix;
    private int location_viewMatrix;
    private int location_transMat;


    public PolygonShaderProgram(Context context) {
        super(context, R.raw.polygon_vertex_shader, R.raw.polygon_fragment_shader);
    }
